...
module pynq_adc_system_top #(
    ...
    localparam [2:0] ADV_PREP_WAVE = 3'd7;
    ...
    reg       adv_frame_prepare_start = 1'b0;
    reg       adv_frame_prepare_started = 1'b0;
    ...
    adv_h0_bypass_core #(
        ...
        .frame_prepare_start(adv_frame_prepare_start),
        .frame_chunk_count(adv_frame_chunk_count),
        .wave_frame(adv_wave_frame),
        .frame_ready(adv_frame_ready),
    ...
    always @(posedge clk_125m) begin
        if (rst) begin
            ...
            adv_frame_prepare_start <= 1'b0;
            adv_frame_prepare_started <= 1'b0;
            adv_tx_pending <= 1'b0;
            ...
            case (adv_state)
                ...
                ADV_PREP_WAVE: begin
                    if (!adv_frame_prepare_started) begin
                        adv_frame_prepare_start <= 1'b1;
                        adv_frame_prepare_started <= 1'b1;
                    end else if (adv_frame_ready) begin
                        adv_frame_prepare_started <= 1'b0;
